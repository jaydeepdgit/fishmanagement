...
public class AmountInWords {
    ...
    public String convertToWords(int n) {
        ...
        String converted = ""; int pos = 1; boolean hun = false;
        while(amount.length() > 0) {
            if(pos == 1) { // TENS AND UNIT POSITION
                ...
                if(converted.length() > 0 && digits(C).toString().equals("")) {
                    ...
                    else converted = (digits(C) + maxs[pos]) + converted; 
                    hun = true;
                }
                pos++; // INCREASING POSITION COUNTER
                ...
                if(amount.length() >= 2) { // EXTRACT 2 DIGITS
                    ...
                    if(!hun && converted.length() > 0)
                        ...
                        else converted = digits(amount) + maxs[pos] + converted;
                        amount = "";
                    }
                }
                pos++; // INCREASING POSITION COUNTER
    ...
    private void input() {
        ...
        try {
            ...
            System.out.println("Number Less than 1 Arab(1000000000) Only Possible. "+e);
            System.exit(1);
        }
    }
